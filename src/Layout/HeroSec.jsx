    ...
    <section className='relative top-5 sm:top-0 bg-white z-10 w-full flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between pt-3 md:pt-20 px-5 pl-2 sm:px-5 md:px-12 lg:px-7 2xl:px-24'>
      {/* Col 1 */}
        <div className='flex flex-col gap-5 justify-start items-start '> 
          ...
          {/* row 1 */}
          <div className='flex  flex-col sm:flex-row gap-5  sm:gap-20  lg:gap-10   justify-center items-start sm:items-center lg:pt-8 2xl:mt-8 px-4'>
          ...
          {/* row 2 */}
          <div className='flex flex-col sm:flex-row  justify-center items-center gap-5 ml-3 sm:ml-0  sm:gap-28 lg:gap-12 lg:pt-5 xl:mt-10 text-[#333333] text-sm font-medium'>
