    ...
    <section className=' max-w-[100vw] '>
        <div className='relative z-0 w-full'>
            ...
            <div className='flex gap-3 z-10 absolute top-2 px-1 sm:top-5 text-xl left-0 sm:left-[10%] md:left-[20%] lg:left-[25%] xl:left-[35%]   text-center '>
                ...
                <h3 className='text-gray-300 text-base'>😍 Get <span className='text-white text-lg  sm:text-[20px]'> 20% Discount </span> get for new account <span className='text-white text-lg sm:text-[20px] underline'>Register now </span> </h3>
            </div>
            </div>
    </section>
  )
