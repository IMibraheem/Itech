...
const SecFour = () => {
  return (
    <section className="relative z-50   ">
      <div className="flex  items-center px-7 md:px-0 gap-10 lg:gap-20 flex-col md:flex-row pt-10 md:pt-0 ">
        {/* col1  */}
        <div className="relative  md:w-[50%] flex flex-col ">
          <img
            src="../img/Sec4/sec4-img.png"
            alt=""
            className="z-40 relative md:min-w-[100%]  lg:min-w-[90%] md:ml-10  lg:pt-3 lg:ml-10 "
          />
        ...
        <div className="md:w-[50%] xl:pr-20 md:pl-10 flex flex-col gap-6 md:gap-3 lg:gap-5 items-start pt-10 ">
          <button className="bg-[#6953D31F] text-[#6953D3] p-2 text-lg 2xl:text-xl rounded-lg font-medium  min-w-[175px]">
          Beautiful Themes
          </button>
