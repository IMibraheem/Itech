  ...
  return (
    <section className='pt-20  md:pt-[20%] lg:pt-30  min-1111:pt-40  xl:pt-28  min-1536:pt-20 min-1736:pt-0  pb-28 '>
        <div className='flex flex-col justify-center items-center gap-5'>
          ...
          <div className='flex flex-col md:flex-row justify-between gap-10 md:gap-0 p-10 items-center w-[90%] lg:min-w-[95%] xl:min-w-[80%] 2xl:w-[60%] mt-6 border  border-gray-700 rounded-2xl'>
