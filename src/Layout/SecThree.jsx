...
const SecThree = () => {
  return (
    <section className="relative z-50 lg:top-0 xl:top-0 2xl:top-0  overflow-hidden ">
      <div className="flex items-center xl:gap-10  flex-col md:flex-row-reverse ">
        ...
        <div className="relative  md:w-[50%]  flex flex-col justify-center items-center">
          <img src="../img/Sec3/sec3-mobile.png" alt="" className="z-40 relative w-[90%]  pt-20 md:pt-3 mr-20"  />
        ...
        {/* col2 */}
        <div className="md:w-[50%] px-4 md:pl-5 lg:pl-10 xl:pl-20 2xl:pl-28 flex flex-col gap-5 2xl:gap-7 items-start pt-10 ">
          ...
          <h4 className="text-gray-500 text-xl lg:pr-16  lg:pt-0 leading-8 lg:leading-9">Automatically syncs across all your devices. You can also access and write notes without internet connection.</h4>

          <div className="flex flex-col gap-6 md:gap-3 lg:gap-6 w-full xl:w-[90%]">
      ...
      <div className='w-full  px-5 rounded-xl flex flex-col gap-5'>
        <div className='flex justify-between w-full text-[#444444]'>
          ...
          <div className=" flex justify-center  items-center bg-[#E7E5E5] min-w-[250px] min-h-[69px] gap-2 rounded-full mt-8 md:mt-0 xl:mt-12">
